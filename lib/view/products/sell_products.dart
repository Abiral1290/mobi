...
//                       });
//                       Get.find<ProductBrandController>().addProductInList(productId);
//                     } else {
...
//       onWillPop: () async {
//         Get.back();
//         //Get.find<ProductBrandController>().removeAllProductFromList();
//         return true;
//       },
//       child: Scaffold(
//         appBar: AppBar(
...
//             if (conn) {
//               Get.find<ProductBrandController>().sellProducts(sales);
//             } else {
...
//                             builder: (ProductBrandController) {
//                               return Get.find<ProductBrandController>()
//                                   .searchProductList !=
//                                   null
//                                   ? Get.find<ProductBrandController>()
//                                   .searchProductList
