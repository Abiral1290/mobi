...
class ViewOutletstPage extends StatefulWidget {
  @override
  State<ViewOutletstPage> createState() => _ViewOutletstPageState();
}

class _ViewOutletstPageState extends State<ViewOutletstPage> {
  // final Outlet outlet;
        ...
        body:   RefreshIndicator(
          ...
          Padding(
            ...
            child: Container(
              ...
              child: GetBuilder<OutletsController>(
                builder: (outletController){
                  return (Get.find<OutletsController>().outletList == null  || Get.find<OutletsController>().outletList.isEmpty) ? Column(
                      mainAxisAlignment:  MainAxisAlignment.center,
